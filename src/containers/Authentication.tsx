...
const providers = {
  [`${AUTH_PROVIDERS.FACEBOOK}`]: new FacebookAuthProvider(),
...
export const Authentication: React.FC = ({ children }): React.ReactElement => {
  ...
  const handleSignInWithProviders = (provider: AUTH_PROVIDERS) => {
              ...
              <div className="mt-6 grid grid-cols-2 gap-2">
                <div>
                  <a
                    ...
                    onClick={() =>
                      handleSignInWithProviders(AUTH_PROVIDERS.FACEBOOK)
                    }
